...
def get_visual_datasource_columns(data):
    datasource_dict = {x["name"]: x["pbi_id"] for x in data["datasources"]}
    datasource_column_dict = {}
    for c in data["columns"]:
        datasource_column_dict.setdefault(c["datasource_pbi_id"], {})[c["name"]] = c[
            "pbi_id"
        ]
    ret = []
            ...
            ret.append(
                {
                    ...
                    "datasource_column_pbi_id": datasource_column_dict[
                        datasource_dict[ds_name]
                    ][ds_column_name],
                    "visual_use": "select",
                }
            )
